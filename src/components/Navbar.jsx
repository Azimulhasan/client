  ...
  return (
    <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6 '>
      <div className='lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24] rounded-[100px]'>
        ...
        <div className='w-[72px] h-full rounded-[20px] bg-green-400 flex justify-center items-center cursor-pointer'>
      ...
      <div className='sm:flex hidden flex-row justify-end gap-4'>
          <CustomButton 
            ...
            styles={address ?'from-green-500 to-emerald-500 focus:ring-green-300 dark:focus:ring-emerald-800': 'from-cyan-500 to-blue-500 focus:ring-cyan-400 dark:focus:ring-cyan-500'} 
            handleClick={()=>{
            if(address){
        ...
        <img
          src={menu}
          alt="menu"
          className="w-[34px] h-[34px] object-contain curson-pointer"
          onClick={()=>{
        ...
        <div className={`absolute top-[60px] right-0 left-0 bg-[#1c1c24] rounded z-10 shadow-secondary py-4 ${!toggleDrawer ? '-translate-y-[100vh]':'translate-y-0'} transition-all duration-500`}>
          ...
          <div className='flex mx-4'>
              <CustomButton 
                btnType='button' 
                title={address ? 'Create a Campaign' : 'Connect'} 
                styles={address ?'from-green-500 to-emerald-700 focus:ring-green-300 dark:focus:ring-emerald-800': 'from-cyan-500 to-blue-500 focus:ring-cyan-300 dark:focus:ring-cyan-800'} 
                handleClick={()=>{
                if(address){
                  navigate('create-campaign')
                }else{
